...
public class ToolState : MonoBehaviour
{
    ...
    public List<ProcessingState> containedItemStates = new List<ProcessingState>();
    ...
    /// </summary>
    public void AddItem(ItemData item, ProcessingState state)
    {
        containedItems.Add(item);
        containedItemStates.Add(state);
    }
    ...
    /// </summary>
    public bool TryGetFirstItem(out ItemData item, out ProcessingState state)
    {
        if (containedItems.Count > 0)
        {
            item = containedItems[0];
            state = containedItemStates[0];
            return true;
        }
